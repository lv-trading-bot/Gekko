...
config['OMLBCT'] = {"startBalance":2500,"startAsset":0,"stopLoss":-10,"takeProfit":2,"amountForOneTrade":100,"stopTrade":24,"backtest":true,"dataFile":"data-for-backtest/backtest-data.json"};
...
config['paperTrader'] = {"enabled":true,"reportInCurrency":true,"simulationBalance":{"asset":0,"currency":2500},"feeMaker":0.1,"feeTaker":0.1,"feeUsing":"maker","slippage":0,"enable":true};
...
config['backtest'] = {"daterange":{"from":"2018-08-01 01:00:00","to":"2018-11-01 01:00:00"},"batchSize":50,"enable":false};
...
config['writeCandle2Json'] = {"fileName":"data-for-backtest/test_binance_BTC_USDT_OMLBCT_60_01-08-18_01-11-18.json","stopTrade":24,"stopLoss":-10,"takeProfit":2};
