...
config['tradingAdvisor'] = {"enabled":true,"method":"writeCandle2Json","candleSize":60,"historySize":0,"enable":true};
...
config['paperTrader'] = {"enabled":true,"reportInCurrency":true,"simulationBalance":{"asset":0,"currency":2500},"feeMaker":0.2,"feeTaker":0.2,"feeUsing":"maker","slippage":0.05,"enable":true};
...
config['backtest'] = {"daterange":{"from":"2019-02-01 01:00:00","to":"2019-02-10 23:00:00"},"batchSize":50,"enable":false};
...
config['writeCandle2Json'] = {"fileName":"data-for-backtest/test_binance_BTC_USDT_OMLBCT_60_01-02-19_10-02-19.json"};
