...
config['paperTrader'] = {"enabled":true,"reportInCurrency":true,"simulationBalance":{"asset":0,"currency":2500},"feeMaker":0.1,"feeTaker":0,"feeUsing":"maker","slippage":0,"enable":true};
...
config['backtest'] = {"daterange":{"from":"2018-08-01 00:00:00","to":"2018-09-30 00:00:00"},"batchSize":50,"enable":false};
...
config['writeCandle2Json'] = {"fileName":"data-for-backtest/test_binance_ETH_USDT_OMLBCT_60_01-08-18_30-09-18.json","stopTrade":24,"stopLoss":-10,"takeProfit":2};
