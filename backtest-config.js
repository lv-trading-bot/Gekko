...
config['OMLBCT'] = {"startBalance":5000,"startAsset":0,"stopLoss":-10,"takeProfit":2,"amountForOneTrade":100,"stopTrade":24,"backtest":true,"dataFile":"data-for-backtest/backtest-data.json"};
...
config['backtest'] = {"daterange":{"from":"2018-12-01 01:00:00","to":"2019-02-20 01:00:00"},"batchSize":50,"enable":false};
...
config['writeCandle2Json'] = {"fileName":"data-for-backtest/test_binance_BTC_USDT_OMLBCT_60_01-12-18_20-02-19.json","stopTrade":24,"stopLoss":-10,"takeProfit":2};
